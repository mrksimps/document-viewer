...
import org.documentviewer.common.settings.LibSettings.Diff;
...
import org.documentviewer.common.settings.listeners.IBackupSettingsChangeListener;
import org.documentviewer.common.settings.listeners.ILibSettingsChangeListener;
import org.documentviewer.ui.library.RecentActivityController;
...
public class DocumentViewerApp extends BaseDroidApp implements IAppSettingsChangeListener, IBackupSettingsChangeListener,
        ILibSettingsChangeListener {

    public static final Flag initialized = new Flag();

    public static DocumentViewerVersion version;

    private static DocumentViewerApp instance;
    ...
    public void onCreate() {
        ...
        instance = this;
        version = DocumentViewerVersion.get(APP_VERSION_CODE);
