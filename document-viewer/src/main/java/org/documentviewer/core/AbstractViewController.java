...
import org.documentviewer.common.touch.DefaultGestureDetector;
import org.documentviewer.common.touch.IGestureDetector;
import org.documentviewer.common.touch.IMultiTouchListener;
import org.documentviewer.common.touch.MultiTouchGestureDetector;
import org.documentviewer.common.touch.TouchManager;
import org.documentviewer.common.touch.TouchManager.Touch;
import org.documentviewer.core.codec.PageLink;
...
public abstract class AbstractViewController extends AbstractComponentController<IView> implements IViewController {
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IViewController#getView()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IViewController#getBase()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IViewController#init(org.documentviewer.ui.viewer.IActivityController.IBookLoadTask)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IViewController#show()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.core.events.ZoomListener#zoomChanged(float, float, boolean)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IViewController#updateMemorySettings()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IViewController#dispatchKeyEvent(android.view.KeyEvent)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IViewController#onTouchEvent(android.view.MotionEvent)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IViewController#onLayoutChanged(boolean, boolean, android.graphics.Rect,
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IViewController#toggleRenderingEffects()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IViewController#invalidateScroll()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IViewController#getFirstVisiblePage()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IViewController#getLastVisiblePage()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IViewController#redrawView()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IViewController#redrawView(org.documentviewer.core.ViewState)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IViewController#goToLink(int, android.graphics.RectF)
     */
    @Override
    ...
    protected class GestureListener extends SimpleOnGestureListener implements IMultiTouchListener {
         ...
         * {@inheritDoc}
         *
         * @see org.documentviewer.common.touch.IMultiTouchListener#onTwoFingerPinch(float, float)
         */
        @Override
         ...
         * {@inheritDoc}
         *
         * @see org.documentviewer.common.touch.IMultiTouchListener#onTwoFingerPinchEnd()
         */
        @Override
         ...
         * {@inheritDoc}
         *
         * @see org.documentviewer.common.touch.IMultiTouchListener#onTwoFingerTap()
         */
        @Override
