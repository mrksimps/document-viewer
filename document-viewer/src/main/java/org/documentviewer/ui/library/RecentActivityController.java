package org.documentviewer.ui.library;
...
import org.documentviewer.common.cache.CacheManager.ICacheListener;
import org.documentviewer.common.cache.ThumbnailFile;
...
import org.documentviewer.common.settings.listeners.ILibSettingsChangeListener;
import org.documentviewer.common.settings.listeners.IRecentBooksChangedListener;
import org.documentviewer.ui.library.adapters.BookNode;
import org.documentviewer.ui.library.adapters.BookShelfAdapter;
import org.documentviewer.ui.library.adapters.BooksAdapter;
import org.documentviewer.ui.library.adapters.LibraryAdapter;
import org.documentviewer.ui.library.adapters.RecentAdapter;
import org.documentviewer.ui.library.dialogs.BackupDlg;
import org.documentviewer.ui.library.dialogs.FolderDlg;
import org.documentviewer.ui.library.tasks.CopyBookTask;
import org.documentviewer.ui.library.tasks.MoveBookTask;
import org.documentviewer.ui.library.tasks.RenameBookTask;
import org.documentviewer.ui.opds.OPDSActivity;
...
public class RecentActivityController extends AbstractActivityController<RecentActivity> implements IBrowserActivity,
    ...
    public void afterCreate(final RecentActivity activity, final boolean recreated) {
        ...
        if (!recreated) {
            ...
            DocumentViewerApp.checkInstalledFonts(getManagedComponent());
        }
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.library.IBrowserActivity#setCurrentDir(java.io.File)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.library.IBrowserActivity#showDocument(android.net.Uri,
     *      org.documentviewer.common.settings.books.Bookmark)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.common.cache.CacheManager.ICacheListener#onThumbnailChanged(org.documentviewer.common.cache.ThumbnailFile)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.library.IBrowserActivity#loadThumbnail(java.lang.String, android.widget.ImageView, int)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.common.settings.listeners.ILibSettingsChangeListener#onLibSettingsChanged(org.documentviewer.common.settings.LibSettings,
     *      org.documentviewer.common.settings.LibSettings, org.documentviewer.common.settings.LibSettings.Diff)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.common.settings.listeners.IRecentBooksChangedListener#onRecentBooksChanged()
     */
    @Override
