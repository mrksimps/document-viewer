...
import org.documentviewer.CodecType;
import org.documentviewer.DocumentViewerApp;
import org.sufficientlysecure.viewer.R;
import org.documentviewer.common.bitmaps.BitmapManager;
import org.documentviewer.common.bitmaps.ByteBufferManager;
import org.documentviewer.common.cache.CacheManager;
import org.documentviewer.common.keysbinding.KeyBindingsDialog;
import org.documentviewer.common.keysbinding.KeyBindingsManager;
...
import org.documentviewer.common.settings.books.Bookmark;
import org.documentviewer.common.settings.listeners.IAppSettingsChangeListener;
import org.documentviewer.common.settings.listeners.IBookSettingsChangeListener;
import org.documentviewer.common.settings.types.BookRotationType;
import org.documentviewer.common.settings.types.DocumentViewMode;
import org.documentviewer.common.touch.TouchManager;
import org.documentviewer.core.DecodeService;
import org.documentviewer.core.NavigationHistory;
...
import org.documentviewer.core.events.CurrentPageListener;
...
import org.documentviewer.droids.mupdf.codec.exceptions.MuPdfPasswordException;
import org.documentviewer.ui.library.dialogs.FolderDlg;
import org.documentviewer.ui.settings.SettingsUI;
import org.documentviewer.ui.viewer.dialogs.GoToPageDialog;
import org.documentviewer.ui.viewer.dialogs.OutlineDialog;
import org.documentviewer.ui.viewer.stubs.ActivityControllerStub;
import org.documentviewer.ui.viewer.stubs.ViewContollerStub;
import org.documentviewer.ui.viewer.views.ManualCropView;
import org.documentviewer.ui.viewer.views.SearchControls;
import org.documentviewer.ui.viewer.views.ViewEffects;
...
public class ViewerActivityController extends AbstractActivityController<ViewerActivity> implements
    ...
    public void startDecoding(final String password) {
        ...
        if (codecType != null && codecType.useCustomFonts ) {
            DocumentViewerApp.checkInstalledFonts(getContext());
        }
        loadTask.run();
    }
    ...
    public void onDestroy(final boolean finishing) {
        if (finishing) {
            ...
            DocumentViewerApp.onActivityClose(finishing);
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.core.events.DecodingProgressListener#decodingProgressChanged(int)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.core.events.CurrentPageListener#currentPageChanged(org.documentviewer.core.PageIndex,
     *      org.documentviewer.core.PageIndex)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IActivityController#runOnUiThread(java.lang.Runnable)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IActivityController#jumpToPage(int, float, float)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IActivityController#getDecodeService()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IActivityController#getDecodingProgressModel()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IActivityController#getDocumentModel()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IActivityController#getSearchModel()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IActivityController#getDocumentController()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IActivityController#getView()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IActivityController#getBookSettings()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IActivityController#getActionController()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.common.settings.listeners.IAppSettingsChangeListener#onAppSettingsChanged(org.documentviewer.common.settings.AppSettings,
     *      org.documentviewer.common.settings.AppSettings, org.documentviewer.common.settings.AppSettings.Diff)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.common.settings.listeners.IBookSettingsChangeListener#onBookSettingsChanged(org.documentviewer.common.settings.books.BookSettings,
     *      org.documentviewer.common.settings.books.BookSettings, org.documentviewer.common.settings.books.BookSettings.Diff)
     */
    @Override
