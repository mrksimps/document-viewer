...
public final class GLView extends GLRootView implements IView, SurfaceHolder.Callback {
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#getView()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#getBase()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#invalidateScroll()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#invalidateScroll(float, float)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#startPageScroll(int, int)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#startFling(float, float, android.graphics.Rect)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#continueScroll()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#forceFinishScroll()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#isScrollFinished()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#checkFullScreenMode()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#scrollTo(int, int)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#getViewRect()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#changeLayoutLock(boolean)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#isLayoutLocked()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#waitForInitialization()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#onDestroy()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#getScrollScaleRatio()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#stopScroller()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#redrawView()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.documentviewer.ui.viewer.IView#getBase(android.graphics.RectF)
     */
    @Override
