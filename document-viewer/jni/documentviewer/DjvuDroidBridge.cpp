...
#define LCTX "DocumentViewer.DJVU"
...
extern "C" jlong Java_org_documentviewer_droids_djvu_codec_DjvuContext_create(JNIEnv *env, jclass cls)
{
...
extern "C" void Java_org_documentviewer_droids_djvu_codec_DjvuContext_free(JNIEnv *env, jclass cls, jlong contextHandle)
{
    ddjvu_context_t* ctx = (ddjvu_context_t*) (contextHandle);
    handleMessages(env, ctx);
                                   ...
                                   miniexp_t sexp)
{
    ...
    jclass pagelinkClass = jenv->FindClass("org/documentviewer/core/codec/PageLink");
    if (!pagelinkClass)
    {
        delete[] data;
        return hl;
...
extern "C" jlong Java_org_documentviewer_droids_djvu_codec_DjvuDocument_open(JNIEnv *env, jclass cls, jlong contextHandle,
                                                                       jstring fileName)
{
...
extern "C" jlong Java_org_documentviewer_droids_djvu_codec_DjvuDocument_getPage(JNIEnv *env, jclass cls, jlong docHandle,
                                                                          jint pageNumber)
{
...
extern "C" jobject Java_org_documentviewer_droids_djvu_codec_DjvuPage_getPageLinks(JNIEnv *env, jclass cls,
...
extern "C" jobject Java_org_documentviewer_droids_djvu_codec_DjvuPage_getPageText(JNIEnv *jenv, jclass cls,
...
extern "C" jint Java_org_documentviewer_droids_djvu_codec_DjvuDocument_getPageInfo(JNIEnv *env, jclass cls, jlong docHandle,
...
extern "C" void Java_org_documentviewer_droids_djvu_codec_DjvuDocument_free(JNIEnv *env, jclass cls, jlong docHandle)
{
    ddjvu_document_release((ddjvu_document_t*) docHandle);
}

extern "C" jint Java_org_documentviewer_droids_djvu_codec_DjvuDocument_getPageCount(JNIEnv *env, jclass cls, jlong docHandle)
{
    return ddjvu_document_get_pagenum(HANDLE_TO_DOC(docHandle));
}

extern "C" jboolean Java_org_documentviewer_droids_djvu_codec_DjvuPage_isDecodingDone(JNIEnv *env, jclass cls,
                                                                                jlong pageHandle)
{
    return ddjvu_page_decoding_done((ddjvu_page_t*) pageHandle);
}

extern "C" jint Java_org_documentviewer_droids_djvu_codec_DjvuPage_getWidth(JNIEnv *env, jclass cls, jlong pageHangle)
{
    return ddjvu_page_get_width((ddjvu_page_t*) pageHangle);
}

extern "C" jint Java_org_documentviewer_droids_djvu_codec_DjvuPage_getHeight(JNIEnv *env, jclass cls, jlong pageHangle)
{
    return ddjvu_page_get_height((ddjvu_page_t*) pageHangle);
}

extern "C" jboolean Java_org_documentviewer_droids_djvu_codec_DjvuPage_renderPageDirect(JNIEnv *env, jclass cls,
...
extern "C" void Java_org_documentviewer_droids_djvu_codec_DjvuPage_free(JNIEnv *env, jclass cls, jlong pageHangle)
{
    ddjvu_page_release((ddjvu_page_t*) pageHangle);
}

//Outline
extern "C" jlong Java_org_documentviewer_droids_djvu_codec_DjvuOutline_open(JNIEnv *env, jclass cls, jlong docHandle)
{
...
extern "C" jboolean Java_org_documentviewer_droids_djvu_codec_DjvuOutline_expConsp(JNIEnv *env, jclass cls, jlong expr)
{
//        DEBUG("DjvuOutline.expConsp(%p)",expr);
    return miniexp_consp((miniexp_t) expr);
}

extern "C" jstring Java_org_documentviewer_droids_djvu_codec_DjvuOutline_getTitle(JNIEnv *env, jclass cls, jlong expr)
{
...
extern "C" jstring Java_org_documentviewer_droids_djvu_codec_DjvuOutline_getLink(JNIEnv *env, jclass cls, jlong expr,
                                                                           jlong docHandle)
{
...
extern "C" jlong Java_org_documentviewer_droids_djvu_codec_DjvuOutline_getNext(JNIEnv *env, jclass cls, jlong expr)
{
//    DEBUG("DjvuOutline.getNext(%p)",expr);
    return (jlong) miniexp_cdr((miniexp_t) expr);
}

extern "C" jlong Java_org_documentviewer_droids_djvu_codec_DjvuOutline_getChild(JNIEnv *env, jclass cls, jlong expr)
{
