...
#define LCTX "DocumentViewer.MuPDF"
...
#define PASSWORD_REQUIRED_EXCEPTION "org/documentviewer/droids/mupdf/codec/exceptions/MuPdfPasswordRequiredException"
#define WRONG_PASSWORD_EXCEPTION "org/documentviewer/droids/mupdf/codec/exceptions/MuPdfWrongPasswordEnteredException"

extern fz_locks_context * jni_new_locks();
extern void jni_free_locks(fz_locks_context *locks);

extern char ext_font_Courier[1024]; //= "/sdcard/.org.documentviewer/fonts/FreeMono.ttf";
extern char ext_font_CourierBold[1024]; // = "/sdcard/.org.documentviewer/fonts/FreeMonoBold.ttf";
extern char ext_font_CourierOblique[1024]; // = "/sdcard/.org.documentviewer/fonts/FreeMonoOblique.ttf";
extern char ext_font_CourierBoldOblique[1024]; // = "/sdcard/.org.documentviewer/fonts/FreeMonoBoldOblique.ttf";
extern char ext_font_Helvetica[1024]; // = "/sdcard/.org.documentviewer/fonts/FreeSans.ttf";
extern char ext_font_HelveticaBold[1024]; // = "/sdcard/.org.documentviewer/fonts/FreeSansBold.ttf";
extern char ext_font_HelveticaOblique[1024]; // = "/sdcard/.org.documentviewer/fonts/FreeSansOblique.ttf";
extern char ext_font_HelveticaBoldOblique[1024]; // = "/sdcard/.org.documentviewer/fonts/FreeSans.ttf";
extern char ext_font_TimesRoman[1024]; // = "/sdcard/.org.documentviewer/fonts/FreeSerif.ttf";
extern char ext_font_TimesBold[1024]; // = "/sdcard/.org.documentviewer/fonts/FreeSerifBold.ttf";
extern char ext_font_TimesItalic[1024]; // = "/sdcard/.org.documentviewer/fonts/FreeSerifItalic.ttf";
extern char ext_font_TimesBoldItalic[1024]; // = "/sdcard/.org.documentviewer/fonts/FreeSerifBoldItalic.ttf";
extern char ext_font_Symbol[1024]; // = "/sdcard/.org.documentviewer/fonts/StandardSymL.cff";
extern char ext_font_ZapfDingbats[1024]; // = "/sdcard/.org.documentviewer/fonts/Dingbats.cff";
...
Java_org_documentviewer_droids_mupdf_codec_MuPdfContext_setMonoFonts(JNIEnv *env, jclass clazz, jstring regular,
...
JNIEXPORT void JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfContext_setSansFonts(JNIEnv *env, jclass clazz, jstring regular,
                                                                 jstring italic, jstring bold, jstring boldItalic)
{
    jboolean iscopy;
    const char* regularFFN = GetStringUTFChars(env, regular, &iscopy);
...
JNIEXPORT void JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfContext_setSerifFonts(JNIEnv *env, jclass clazz, jstring regular,
                                                                 jstring italic, jstring bold, jstring boldItalic)
{
    jboolean iscopy;
    const char* regularFFN = GetStringUTFChars(env, regular, &iscopy);
...
JNIEXPORT void JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfContext_setSymbolFont(JNIEnv *env, jclass clazz, jstring regular)
{
    jboolean iscopy;
    const char* regularFFN = GetStringUTFChars(env, regular, &iscopy);
...
JNIEXPORT void JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfContext_setDingbatFont(JNIEnv *env, jclass clazz, jstring regular)
{
    jboolean iscopy;
    const char* regularFFN = GetStringUTFChars(env, regular, &iscopy);
...
Java_org_documentviewer_droids_mupdf_codec_MuPdfDocument_open(JNIEnv *env, jclass clazz, jint storememory, jint format, jstring fname,
                                                      jstring pwd)
{
...
JNIEXPORT void JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfDocument_free(JNIEnv *env, jclass clazz, jlong handle)
{
...
Java_org_documentviewer_droids_mupdf_codec_MuPdfDocument_getPageInfo(JNIEnv *env, jclass cls, jlong handle, jint pageNumber,
                                                             jobject cpi)
{
    renderdocument_t *doc = (renderdocument_t*) (long) handle;
...
JNIEXPORT jlong JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfLinks_getFirstPageLink(JNIEnv *env, jclass clazz, jlong handle,
                                                               jlong pagehandle)
{
    renderdocument_t *doc = (renderdocument_t*) (long) handle;
...
JNIEXPORT jlong JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfLinks_getNextPageLink(JNIEnv *env, jclass clazz, jlong linkhandle)
{
...
JNIEXPORT jint JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfLinks_getPageLinkType(JNIEnv *env, jclass clazz, jlong linkhandle)
{
    fz_link *link = (fz_link*) (long) linkhandle;
...
Java_org_documentviewer_droids_mupdf_codec_MuPdfLinks_getPageLinkUrl(JNIEnv *env, jclass clazz, jlong linkhandle)
{
    fz_link *link = (fz_link*) (long) linkhandle;
...
Java_org_documentviewer_droids_mupdf_codec_MuPdfLinks_fillPageLinkSourceRect(JNIEnv *env, jclass clazz, jlong linkhandle,
...
JNIEXPORT jint JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfLinks_getPageLinkTargetPage(JNIEnv *env, jclass clazz, jlong linkhandle)
{
    fz_link *link = (fz_link*) (long) linkhandle;
...
JNIEXPORT jint JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfLinks_fillPageLinkTargetPoint(JNIEnv *env, jclass clazz, jlong linkhandle,
...
JNIEXPORT jint JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfDocument_getPageCount(JNIEnv *env, jclass clazz, jlong handle)
{
    renderdocument_t *doc = (renderdocument_t*) (long) handle;
...
JNIEXPORT jlong JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfPage_open(JNIEnv *env, jclass clazz, jlong dochandle, jint pageno)
{
...
JNIEXPORT void JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfPage_free(JNIEnv *env, jclass clazz, jlong dochandle, jlong handle)
{
    renderdocument_t *doc = (renderdocument_t*) (long) dochandle;
...
JNIEXPORT void JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfPage_getBounds(JNIEnv *env, jclass clazz, jlong dochandle, jlong handle,
                                                       jfloatArray bounds)
{
    renderdocument_t *doc = (renderdocument_t*) (long) dochandle;
    renderpage_t *page = (renderpage_t*) (long) handle;
...
JNIEXPORT jboolean JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfPage_renderPageDirect(JNIEnv *env, jobject this, jlong dochandle,
...
//    DEBUG("MuPdfPage_renderPageBitmap(%p, %p): start", doc, page);
    ...
    ctx->documentviewer_nightmode = nightmode;

    //add check for slowcmyk mode and set global variable accordingly
    ctx->documentviewer_slowcmyk = slowcmyk;
...
Java_org_documentviewer_droids_mupdf_codec_MuPdfPage_search(JNIEnv * env, jobject thiz, jlong dochandle, jlong pagehandle,
                                                        jstring text)
{
...
//Outline
JNIEXPORT jlong JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfOutline_open(JNIEnv *env, jclass clazz, jlong dochandle)
{
    renderdocument_t *doc = (renderdocument_t*) (long) dochandle;
    if (!doc->outline)
...
JNIEXPORT void JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfOutline_free(JNIEnv *env, jclass clazz, jlong dochandle)
{
    renderdocument_t *doc = (renderdocument_t*) (long) dochandle;
...
JNIEXPORT jstring JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfOutline_getTitle(JNIEnv *env, jclass clazz, jlong outlinehandle)
{
...
JNIEXPORT jstring JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfOutline_getLink(JNIEnv *env, jclass clazz, jlong outlinehandle, jlong dochandle)
{
    fz_outline *outline = (fz_outline*) (long) outlinehandle;
    renderdocument_t *doc = (renderdocument_t*) (long) dochandle;
...
JNIEXPORT jint JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfOutline_fillLinkTargetPoint(JNIEnv *env, jclass clazz, jlong outlinehandle,
                                                                      jfloatArray pointArray)
{
    fz_outline *outline = (fz_outline*) (long) outlinehandle;
...
JNIEXPORT jlong JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfOutline_getNext(JNIEnv *env, jclass clazz, jlong outlinehandle)
{
    fz_outline *outline = (fz_outline*) (long) outlinehandle;
...
JNIEXPORT jlong JNICALL
Java_org_documentviewer_droids_mupdf_codec_MuPdfOutline_getChild(JNIEnv *env, jclass clazz, jlong outlinehandle)
{
    fz_outline *outline = (fz_outline*) (long) outlinehandle;
