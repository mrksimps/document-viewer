...
#define LCTX "DocumentViewer.ByteBufferBitmap"
...
Java_org_documentviewer_common_bitmaps_ByteBufferBitmap_create(JNIEnv* env, jclass classObject, jint size)
{
...
Java_org_documentviewer_common_bitmaps_ByteBufferBitmap_free(JNIEnv* env, jclass classObject, jobject obj)
{
    if (!obj)
    {
        return;
...
JNIEXPORT void JNICALL
Java_org_documentviewer_common_bitmaps_ByteBufferBitmap_nativeInvert(JNIEnv* env, jclass classObject, jobject srcBuffer,
...
JNIEXPORT void JNICALL
Java_org_documentviewer_common_bitmaps_ByteBufferBitmap_nativeFillAlpha(JNIEnv* env, jclass classObject, jobject srcBuffer,
...
JNIEXPORT void JNICALL
Java_org_documentviewer_common_bitmaps_ByteBufferBitmap_nativeEraseColor(JNIEnv* env, jclass classObject, jobject srcBuffer,
...
JNIEXPORT void JNICALL
Java_org_documentviewer_common_bitmaps_ByteBufferBitmap_nativeContrast(JNIEnv* env, jclass classObject, jobject srcBuffer,
...
JNIEXPORT void JNICALL
Java_org_documentviewer_common_bitmaps_ByteBufferBitmap_nativeGamma(JNIEnv* env, jclass classObject, jobject srcBuffer,
...
Java_org_documentviewer_common_bitmaps_ByteBufferBitmap_nativeAvgLum(JNIEnv* env, jclass classObject, jobject srcBuffer,
                                                                 jint width, jint height, jint contrast)
{
    int i, a;
    int midBright = 0;
...
JNIEXPORT void JNICALL
Java_org_documentviewer_common_bitmaps_ByteBufferBitmap_nativeExposure(JNIEnv* env, jclass classObject, jobject srcBuffer,
...
JNIEXPORT void JNICALL
Java_org_documentviewer_common_bitmaps_ByteBufferBitmap_nativeAutoLevels(JNIEnv* env, jclass classObject, jobject srcBuffer,
                                                                     jint width, jint height)
{
    int i;
    int histoR[256];
...
JNIEXPORT void JNICALL
Java_org_documentviewer_common_bitmaps_ByteBufferBitmap_nativeAutoLevels2(JNIEnv* env, jclass classObject,
...
JNIEXPORT void JNICALL
Java_org_documentviewer_common_bitmaps_ByteBufferBitmap_nativeFillRect(JNIEnv* env, jclass classObject, jobject srcBuffer,
