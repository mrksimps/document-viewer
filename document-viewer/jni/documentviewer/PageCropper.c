...
#define LCTX "DocumentViewer.PageCropper"
...
Java_org_documentviewer_core_crop_PageCropper_nativeGetCropBounds(JNIEnv* env, jclass clz, jobject pixels, jint width,
...
JNIEXPORT jobject JNICALL
Java_org_documentviewer_core_crop_PageCropper_nativeGetColumn(JNIEnv* env, jclass clz, jobject pixels, jint width,
